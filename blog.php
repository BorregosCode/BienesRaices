...
?>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    <source srcset="build/img/blog3.webp" type="imege/webp">
                    <source srcset="build/img/blog3.jpg" type="imege/jpeg">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    <source srcset="build/img/blog4.webp" type="imege/webp">
                    <source srcset="build/img/blog4.jpg" type="imege/jpeg">
